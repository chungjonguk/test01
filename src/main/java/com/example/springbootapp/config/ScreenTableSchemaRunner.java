...
public class ScreenTableSchemaRunner implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) {
		try {
			...
			populator.addScript(new ClassPathResource("schema/dashboard_company_config.sql"));
			populator.addScript(new ClassPathResource("schema/biz_company_page_image.sql"));
			populator.addScript(new ClassPathResource("schema/biz_company_domain.sql"));
			populator.addScript(new ClassPathResource("schema/biz_company_domain_ssl_alter.sql"));
