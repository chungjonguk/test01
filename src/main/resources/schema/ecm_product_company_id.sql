...
ALTER TABLE ecm_product ADD COLUMN company_id BIGINT NULL COMMENT '업체ID(biz_company)' AFTER product_id;
ALTER TABLE ecm_product ADD KEY idx_ecm_product_company (company_id);
